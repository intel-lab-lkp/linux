...
pub mod code {
    macro_rules! declare_err {
        ($err:tt $(,)? $($doc:expr),+) => {
            ...
            // SAFETY: `err` is checked to be non-zero.
            pub const $err: super::Error = unsafe {
                super::Error(core::num::NonZeroI32::new_unchecked(-(crate::bindings::$err as i32)))
            };
        };
    }
...
impl Error {
    ...
    pub(crate) fn from_errno(errno: core::ffi::c_int) -> Error {
        ...
        // will hold.
        // SAFETY: `errno` is checked to be non-zero.
