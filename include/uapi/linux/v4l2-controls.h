...
#define V4L2_CID_DV_TX_HDCP_MODE		(V4L2_CID_DV_CLASS_BASE + 7)
enum v4l2_dv_tx_hdcp_mode {
	V4L2_DV_TX_HDCP_DISABLED = 0,
	V4L2_DV_TX_HDCP_DESIRED  = 1,
	V4L2_DV_TX_HDCP_ENABLED  = 2,
};
...
#define V4L2_CID_DV_RX_HDCP_DETECTED		(V4L2_CID_DV_CLASS_BASE + 103)
#define V4L2_CID_DV_RX_HDCP_ENABLE		(V4L2_CID_DV_CLASS_BASE + 104)
#define V4L2_CID_DV_RX_HDCP_REP_DEVICE_COUNT	(V4L2_CID_DV_CLASS_BASE + 105)
#define V4L2_CID_DV_RX_HDCP_REP_DEPTH		(V4L2_CID_DV_CLASS_BASE + 106)
#define V4L2_CID_DV_RX_HDCP_REP_MAX_DEVS_EXCEEDED	(V4L2_CID_DV_CLASS_BASE + 107)
#define V4L2_CID_DV_RX_HDCP_REP_MAX_CASCADE_EXCEEDED	(V4L2_CID_DV_CLASS_BASE + 108)
#define V4L2_CID_DV_RX_HDCP_REP_KSV_FIFO	(V4L2_CID_DV_CLASS_BASE + 109)
#define V4L2_CID_DV_RX_HDCP_REP_READY		(V4L2_CID_DV_CLASS_BASE + 110)
