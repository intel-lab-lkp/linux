...
#define BTRFS_QGROUP_STATUS_FLAG_INCONSISTENT	\
	(1ULL << BTRFS_QGROUP_STATUS_BIT_INCONSISTENT)
...
#define BTRFS_QGROUP_STATUS_FLAG_SIMPLE_MODE	\
	(1ULL << BTRFS_QGROUP_STATUS_BIT_SIMPLE_MODE)
