...
struct drm_dp_mst_topology_state *
drm_atomic_get_mst_topology_state(struct drm_atomic_update *state,
				  struct drm_dp_mst_topology_mgr *mgr);
struct drm_dp_mst_topology_state *
...
int __must_check
drm_dp_atomic_find_time_slots(struct drm_atomic_update *state,
			      struct drm_dp_mst_topology_mgr *mgr,
...
int drm_dp_mst_atomic_enable_dsc(struct drm_atomic_update *state,
				 ...
				 int pbn, bool enable);
int __must_check
drm_dp_mst_add_affected_dsc_crtcs(struct drm_atomic_update *state,
				  struct drm_dp_mst_topology_mgr *mgr);
int __must_check
drm_dp_atomic_release_time_slots(struct drm_atomic_update *state,
				 struct drm_dp_mst_topology_mgr *mgr,
				 struct drm_dp_mst_port *port);
void drm_dp_mst_atomic_wait_for_dependencies(struct drm_atomic_update *state);
int __must_check drm_dp_mst_atomic_setup_commit(struct drm_atomic_update *state);
int drm_dp_send_power_updown_phy(struct drm_dp_mst_topology_mgr *mgr,
				 struct drm_dp_mst_port *port, bool power_up);
int drm_dp_send_query_stream_enc_status(struct drm_dp_mst_topology_mgr *mgr,
		struct drm_dp_mst_port *port,
		struct drm_dp_query_stream_enc_status_ack_reply *status);
int __must_check drm_dp_mst_atomic_check_mgr(struct drm_atomic_update *state,
					     struct drm_dp_mst_topology_mgr *mgr,
					     struct drm_dp_mst_topology_state *mst_state,
					     struct drm_dp_mst_port **failing_port);
int __must_check drm_dp_mst_atomic_check(struct drm_atomic_update *state);
 ...
 * macro-internal use
 * @state: &struct drm_atomic_update pointer
 ...
 */
static inline bool
__drm_dp_mst_state_iter_get(struct drm_atomic_update *state,
			    struct drm_dp_mst_topology_mgr **mgr,
