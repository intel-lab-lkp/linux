...
static inline int
drm_dp_tunnel_atomic_set_stream_bw(struct drm_atomic_update *state,
				   struct drm_dp_tunnel *tunnel,
				   u8 stream_id, int bw)
{
	return -EOPNOTSUPP;
...
static inline int
drm_dp_tunnel_atomic_get_group_streams_in_state(struct drm_atomic_update *state,
						const struct drm_dp_tunnel *tunnel,
						u32 *stream_mask)
{
	return -EOPNOTSUPP;
...
static inline int
drm_dp_tunnel_atomic_check_stream_bws(struct drm_atomic_update *state,
				      u32 *failed_stream_mask)
{
	return -EOPNOTSUPP;
}
