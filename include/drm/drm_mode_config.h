...
struct drm_mode_config_funcs {
	 ...
	 * callback.
	 *
	 * See the documentation for &struct drm_atomic_update for how exactly
	 ...
	 * &drm_atomic_update to be able to track their own driver-private global
	 * state easily. If this hook is implemented, drivers must also
	 * implement @atomic_state_clear and @atomic_state_free.
	 *
	 * Subclassing of &drm_atomic_update is deprecated in favour of using
	 * &drm_private_state and &drm_private_obj.
	 *
	 * RETURNS:
	 *
	 * A new &drm_atomic_update on success or NULL on failure.
	 */
	struct drm_atomic_update *(*atomic_state_alloc)(struct drm_device *dev);

	/**
	 * @atomic_state_clear:
	 *
	 * This hook must clear any driver private state duplicated into the
	 * passed-in &drm_atomic_update. This hook is called when the caller
	 ...
	 *
	 * Drivers that implement this must call drm_atomic_update_default_clear()
	 * to clear common state.
	 *
	 * Subclassing of &drm_atomic_update is deprecated in favour of using
	 * &drm_private_state and &drm_private_obj.
	 */
	void (*atomic_state_clear)(struct drm_atomic_update *state);

	/**
	 * @atomic_state_free:
	 *
	 * This hook needs driver private resources and the &drm_atomic_update
	 * itself. Note that the core first calls drm_atomic_update_clear() to
	 * avoid code duplicate between the clear and free hooks.
	 *
	 * Drivers that implement this must call
	 * drm_atomic_update_default_release() to release common resources.
	 *
	 * Subclassing of &drm_atomic_update is deprecated in favour of using
	 * &drm_private_state and &drm_private_obj.
	 */
	void (*atomic_state_free)(struct drm_atomic_update *state);
};
