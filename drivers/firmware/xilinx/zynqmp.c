...
static noinline int do_fw_call_fail(u32 *ret_payload, u8 num_args, ...)
{
	return -ENODEV;
}
 ...
 */
static int (*do_fw_call)(u32 *ret_payload, u8, ...) = do_fw_call_fail;
 ...
 */
static noinline int do_fw_call_smc(u32 *ret_payload, u8 num_args, ...)
{
 ...
 * Return: Returns status, either success or error+reason
 */
static noinline int do_fw_call_hvc(u32 *ret_payload, u8 num_args, ...)
{
	struct arm_smccc_res res;
	u64 args[8] = {0};
	va_list arg_list;
