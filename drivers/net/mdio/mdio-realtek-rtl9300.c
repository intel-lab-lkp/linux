...
{
	return ((struct otto_emdio_chan *)bus->priv)->priv;
}
...
static int otto_emdio_9300_read_c22(struct mii_bus *bus, int port, int regnum, u32 *value)
{
	...
	return otto_emdio_run_cmd(bus, PHY_CTRL_TYPE_C22 | PHY_CTRL_READ, &cmd_data, value);
}
				    ...
				    int dev_addr, int regnum, u32 *value)
{
	...
	return otto_emdio_run_cmd(bus, PHY_CTRL_TYPE_C45 | PHY_CTRL_READ, &cmd_regs, value);
}
