 ...
 *             valid ID returned by the bridge allocation.
 *
 ...
 * @MXL862XX_BRIDGE_FORWARD_CPU: Packet is forwarded to logical port 0 CTP
 *                                port 0 bridge port 0
 */
 ...
 *                                traffic. See &enum mxl862xx_bridge_forward_mode
 * @forward_unknown_multicast_non_ip: Forwarding mode of unknown multicast
 *                                    non-IP traffic. See &enum mxl862xx_bridge_forward_mode
 ...
 *                        non-VLAN tagged packets. Entries 1-8 are PCP mapping entries for VLAN
 *                        tagged packets. Entries 9-72 are DSCP or LAG mapping entries.
 *
 ...
 *                   represents one bridge port. Bridge port ID is index * 16 + bit
 *                   offset.
 ...
 *                      learning, lookup and filtering. 0 - Intermediate outer VLAN tag is
 *                      used. 1 - Original outer VLAN tag is used.
