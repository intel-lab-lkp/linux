				...
				unsigned long *lock_flag)
{
	...
	/*
	* SPACC_AADCOPY_FLAG enables AAD copy.
	* max_msg_size supports max single-job length (16KB/32KB/64KB/256KB/
	* 512KB); and its value is read from the PROC_LEN register.
	*/
