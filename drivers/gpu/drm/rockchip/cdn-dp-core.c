...
static void cdn_dp_bridge_atomic_enable(struct drm_bridge *bridge, struct drm_atomic_update *state)
{
	struct cdn_dp_device *dp = bridge_to_dp(bridge);
...
static void cdn_dp_bridge_atomic_disable(struct drm_bridge *bridge, struct drm_atomic_update *state)
{
	struct cdn_dp_device *dp = bridge_to_dp(bridge);
	int ret;
