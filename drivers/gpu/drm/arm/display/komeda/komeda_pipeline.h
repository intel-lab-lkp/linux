 ...
 */
struct komeda_component_state {
	/** @obj: tracking component_state by drm_atomic_update */
 ...
 */
struct komeda_pipeline {
	/** @obj: link pipeline as private obj of drm_atomic_update */
	struct drm_private_obj obj;
 ...
 * into it. It because all component will be managed by drm_atomic_update.
 */
struct komeda_pipeline_state {
	/** @obj: tracking pipeline_state by drm_atomic_update */
	struct drm_private_state obj;
