...
static void komeda_kms_atomic_commit_hw_done(struct drm_atomic_update *state)
{
...
static void komeda_kms_commit_tail(struct drm_atomic_update *old_state)
{
...
{
	struct drm_atomic_update *state = crtc_st->state;
