...
static void vkms_atomic_commit_tail(struct drm_atomic_update *old_state)
{
...
static int vkms_atomic_check(struct drm_device *dev, struct drm_atomic_update *state)
{
	struct drm_crtc *crtc;
