...
struct vc4_hvs_state *vc4_hvs_get_global_state(struct drm_atomic_update *state);
struct vc4_hvs_state *vc4_hvs_get_old_global_state(const struct drm_atomic_update *state);
struct vc4_hvs_state *vc4_hvs_get_new_global_state(const struct drm_atomic_update *state);
...
struct vc4_encoder {
	...
	void (*pre_crtc_configure)(struct drm_encoder *encoder, struct drm_atomic_update *state);
	void (*pre_crtc_enable)(struct drm_encoder *encoder, struct drm_atomic_update *state);
	void (*post_crtc_enable)(struct drm_encoder *encoder, struct drm_atomic_update *state);

	void (*post_crtc_disable)(struct drm_encoder *encoder, struct drm_atomic_update *state);
	void (*post_crtc_powerdown)(struct drm_encoder *encoder, struct drm_atomic_update *state);
};
...
void vc4_hvs_atomic_begin(struct drm_crtc *crtc, struct drm_atomic_update *state);
void vc4_hvs_atomic_enable(struct drm_crtc *crtc, struct drm_atomic_update *state);
void vc4_hvs_atomic_disable(struct drm_crtc *crtc, struct drm_atomic_update *state);
void vc4_hvs_atomic_flush(struct drm_crtc *crtc, struct drm_atomic_update *state);
