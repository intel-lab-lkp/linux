...
int drm_sysfb_plane_helper_atomic_check(struct drm_plane *plane,
					struct drm_atomic_update *new_state)
{
...
void drm_sysfb_plane_helper_atomic_update(struct drm_plane *plane, struct drm_atomic_update *state)
{
	struct drm_device *dev = plane->dev;
...
int drm_sysfb_crtc_helper_atomic_check(struct drm_crtc *crtc, struct drm_atomic_update *new_state)
{
