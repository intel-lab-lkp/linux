...
static int intel_modeset_disable_planes(struct drm_atomic_update *state,
			   ...
			   struct drm_modeset_acquire_ctx *ctx)
{
	...
	struct drm_atomic_update *state = NULL, *restore_state = NULL;
...
found:
	...
	restore_state = drm_atomic_update_alloc(display->drm);
...
fail:
	...
	if (restore_state) {
		drm_atomic_update_put(restore_state);
		restore_state = NULL;
	}
