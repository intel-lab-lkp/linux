...
void nv50_crc_atomic_stop_reporting(struct drm_atomic_update *state)
{
...
void nv50_crc_atomic_init_notifier_contexts(struct drm_atomic_update *state)
{
...
void nv50_crc_atomic_release_notifier_contexts(struct drm_atomic_update *state)
{
	const struct nv50_crc_func *func =
...
void nv50_crc_atomic_start_reporting(struct drm_atomic_update *state)
{
	struct drm_crtc_state *crtc_state;
	struct drm_crtc *crtc;
	int i;
