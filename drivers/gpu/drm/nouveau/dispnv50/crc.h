...
void nv50_crc_atomic_stop_reporting(struct drm_atomic_update *);
void nv50_crc_atomic_init_notifier_contexts(struct drm_atomic_update *);
void nv50_crc_atomic_release_notifier_contexts(struct drm_atomic_update *);
void nv50_crc_atomic_start_reporting(struct drm_atomic_update *);
...
static inline void
nv50_crc_atomic_stop_reporting(struct drm_atomic_update *state) {}
static inline void
nv50_crc_atomic_init_notifier_contexts(struct drm_atomic_update *state) {}
static inline void
nv50_crc_atomic_release_notifier_contexts(struct drm_atomic_update *state) {}
static inline void
nv50_crc_atomic_start_reporting(struct drm_atomic_update *state) {}
static inline void
