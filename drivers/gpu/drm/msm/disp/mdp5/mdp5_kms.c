 ...
 */
struct mdp5_global_state *mdp5_get_global_state(struct drm_atomic_update *s)
{
...
static void mdp5_prepare_commit(struct msm_kms *kms, struct drm_atomic_update *state)
{
	struct mdp5_kms *mdp5_kms = to_mdp5_kms(to_mdp_kms(kms));
