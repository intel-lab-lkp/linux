 ...
 */
struct dpu_global_state *dpu_kms_get_global_state(struct drm_atomic_update *s)
{
...
static int dpu_kms_check_mode_changed(struct msm_kms *kms, struct drm_atomic_update *state)
{
