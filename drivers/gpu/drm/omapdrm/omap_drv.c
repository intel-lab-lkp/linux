...
static void omap_atomic_commit_tail(struct drm_atomic_update *old_state)
{
...
static int drm_atomic_update_normalized_zpos_cmp(const void *a, const void *b)
{
					     ...
					     struct drm_atomic_update *state)
{
	...
	for_each_oldnew_crtc_in_state(state, crtc, old_state, new_state, c) {
		...
		sort(states, n, sizeof(*states),
		     drm_atomic_update_normalized_zpos_cmp, NULL);
...
omap_get_global_state(struct drm_atomic_update *s)
{
