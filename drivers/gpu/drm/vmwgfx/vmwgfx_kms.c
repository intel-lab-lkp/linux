...
vmw_crtc_state_and_lock(struct drm_atomic_update *state, struct drm_crtc *crtc)
{
...
/**
 * vmw_kms_check_topology - Validates topology in drm_atomic_update
 * @dev: DRM device
...
static void
vmw_atomic_commit_tail(struct drm_atomic_update *old_state)
{
