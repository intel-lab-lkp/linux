...
static int
dc_plane_atomic_check(struct drm_plane *plane, struct drm_atomic_update *state)
{
...
static void
dc_plane_atomic_update(struct drm_plane *plane, struct drm_atomic_update *state)
{
