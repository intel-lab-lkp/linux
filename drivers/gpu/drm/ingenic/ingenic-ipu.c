...
ingenic_ipu_get_priv_state(struct ingenic_ipu *priv, struct drm_atomic_update *state)
{
...
static struct ingenic_ipu_private_state *
ingenic_ipu_get_new_priv_state(struct ingenic_ipu *priv, struct drm_atomic_update *state)
{
	struct drm_private_state *priv_state;
