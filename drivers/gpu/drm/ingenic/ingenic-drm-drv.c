...
ingenic_drm_get_priv_state(struct ingenic_drm *priv, struct drm_atomic_update *state)
{
...
static struct ingenic_drm_private_state *
ingenic_drm_get_new_priv_state(struct ingenic_drm *priv, struct drm_atomic_update *state)
{
	struct drm_private_state *priv_state;
