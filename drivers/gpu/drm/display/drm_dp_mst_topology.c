 ...
 */
int drm_dp_atomic_find_time_slots(struct drm_atomic_update *state,
				  struct drm_dp_mst_topology_mgr *mgr,
 ...
 */
int drm_dp_atomic_release_time_slots(struct drm_atomic_update *state,
				     struct drm_dp_mst_topology_mgr *mgr,
				     struct drm_dp_mst_port *port)
{
	struct drm_dp_mst_topology_state *topology_state;
 ...
 */
int drm_dp_mst_atomic_setup_commit(struct drm_atomic_update *state)
{
	struct drm_dp_mst_topology_mgr *mgr;
	struct drm_dp_mst_topology_state *mst_state;
 ...
 */
void drm_dp_mst_atomic_wait_for_dependencies(struct drm_atomic_update *state)
{
...
int drm_dp_mst_root_conn_atomic_check(struct drm_connector_state *new_conn_state,
				      struct drm_dp_mst_topology_mgr *mgr)
{
	struct drm_atomic_update *state = new_conn_state->state;
 ...
 */
int drm_dp_mst_add_affected_dsc_crtcs(struct drm_atomic_update *state, struct drm_dp_mst_topology_mgr *mgr)
{
	struct drm_dp_mst_topology_state *mst_state;
	struct drm_dp_mst_atomic_payload *pos;
 ...
 * @state: Pointer to the new drm_atomic_update
 ...
 *
 */
int drm_dp_mst_atomic_enable_dsc(struct drm_atomic_update *state,
				 struct drm_dp_mst_port *port,
				 int pbn, bool enable)
{
	struct drm_dp_mst_topology_state *mst_state;
 ...
 *     too many payloads.
 */
int drm_dp_mst_atomic_check_mgr(struct drm_atomic_update *state,
				struct drm_dp_mst_topology_mgr *mgr,
				struct drm_dp_mst_topology_state *mst_state,
				struct drm_dp_mst_port **failing_port)
{
 ...
 */
int drm_dp_mst_atomic_check(struct drm_atomic_update *state)
{
	struct drm_dp_mst_topology_mgr *mgr;
	struct drm_dp_mst_topology_state *mst_state;
	int i, ret = 0;
 ...
 */
struct drm_dp_mst_topology_state *drm_atomic_get_mst_topology_state(struct drm_atomic_update *state,
								    struct drm_dp_mst_topology_mgr *mgr)
{
...
drm_atomic_get_old_mst_topology_state(struct drm_atomic_update *state,
				      struct drm_dp_mst_topology_mgr *mgr)
{
 ...
 */
struct drm_dp_mst_topology_state *
drm_atomic_get_new_mst_topology_state(struct drm_atomic_update *state,
				      struct drm_dp_mst_topology_mgr *mgr)
{
