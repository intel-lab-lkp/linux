...
struct mgag200_device_funcs {
	 ...
	 */
	int (*pixpllc_atomic_check)(struct drm_crtc *crtc, struct drm_atomic_update *new_state);
	 ...
	 */
	void (*pixpllc_atomic_update)(struct drm_crtc *crtc, struct drm_atomic_update *old_state);
};
...
void mgag200_g200wb_pixpllc_atomic_update(struct drm_crtc *crtc, struct drm_atomic_update *old_state);
struct mga_device *mgag200_g200wb_device_create(struct pci_dev *pdev, const struct drm_driver *drv);
struct mga_device *mgag200_g200ev_device_create(struct pci_dev *pdev, const struct drm_driver *drv);
void mgag200_g200eh_init_registers(struct mga_device *mdev);
void mgag200_g200eh_pixpllc_atomic_update(struct drm_crtc *crtc, struct drm_atomic_update *old_state);
