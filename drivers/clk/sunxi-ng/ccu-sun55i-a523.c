...
/* HDMI not documented in the A523 manual, but found in T527 BSP. */
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(isp_clk, "isp-clk",
				     isp_parents, 0xc14,
				     0, 5,	/* M */
				     8, 5,	/* P */
				     24, 3,	/* mux */
...
static struct ccu_reset_map sun55i_a523_ccu_resets[] = {
	...
	[RST_BUS_EMAC1]		= { 0x98c, BIT(16) },	/* BIT(17) as well? */
	...
	[RST_BUS_HDMI_MAIN]	= { 0xb1c, BIT(16) },	/* BSP + register */
	[RST_BUS_HDMI_SUB]	= { 0xb1c, BIT(17) },	/* BSP + register */
	[RST_BUS_MIPI_DSI0]	= { 0xb4c, BIT(16) },
	[RST_BUS_MIPI_DSI1]	= { 0xb4c, BIT(17) },
	[RST_BUS_TCON_LCD0]	= { 0xb7c, BIT(16) },
	[RST_BUS_TCON_LCD1]	= { 0xb7c, BIT(17) },
	[RST_BUS_VO1_TCONLCD0]	= { 0xb7c, BIT(18) },	/* BSP + register */
	[RST_BUS_TCON_TV0]	= { 0xb9c, BIT(16) },
	[RST_BUS_TCON_TV1]	= { 0xb9c, BIT(17) },
	[RST_BUS_LVDS0]		= { 0xbac, BIT(16) },
	[RST_BUS_LVDS1]		= { 0xbac, BIT(17) },	/* BSP + register */
	[RST_BUS_EDP]		= { 0xbbc, BIT(16) },
	[RST_BUS_VIDEO_OUT0]	= { 0xbcc, BIT(16) },
	[RST_BUS_VIDEO_OUT1]	= { 0xbcc, BIT(16) },	/* register */
