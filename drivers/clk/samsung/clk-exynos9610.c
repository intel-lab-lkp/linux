...
#define EXYNOS9610_ALT_DRCG_EN_OFFSET 0x1000
...
PNAME(mout_cmu_cis_clk_p)	= { "oscclk",
				    "dout_cmu_shared0_div4" };
...
static const struct samsung_mux_clock top_mux_clks[] __initconst = {
	...
	MUX(CLK_MOUT_CMU_CIS_CLK0, "mout_cmu_cis_clk0", mout_cmu_cis_clk_p,
	    CLK_CON_MUX_MUX_CLKCMU_CIS_CLK0, 0, 1),
	MUX(CLK_MOUT_CMU_CIS_CLK1, "mout_cmu_cis_clk1", mout_cmu_cis_clk_p,
	    CLK_CON_MUX_MUX_CLKCMU_CIS_CLK1, 0, 1),
	MUX(CLK_MOUT_CMU_CIS_CLK2, "mout_cmu_cis_clk2", mout_cmu_cis_clk_p,
	    CLK_CON_MUX_MUX_CLKCMU_CIS_CLK2, 0, 1),
	MUX(CLK_MOUT_CMU_CIS_CLK3, "mout_cmu_cis_clk3", mout_cmu_cis_clk_p,
...
static const struct samsung_div_clock top_div_clks[] __initconst = {
	...
	DIV(CLK_DOUT_CMU_USB_USB30DRD, "dout_cmu_usb_usb30drd", "gout_cmu_usb_usb30drd",
...
static const unsigned long drcg_alt_memclk_sysreg[] __initconst = {
	EXYNOS9610_MEMCLK_OFFSET,
	EXYNOS9610_ALT_DRCG_EN_OFFSET,
};
...
PNAME(mout_clk_apm_bus_p)		= { "mout_pll_apm_bus_user", "dll_dco" };
...
static const struct samsung_cmu_info cam_cmu_info __initconst = {
	...
	.sysreg_clk_regs	= drcg_alt_memclk_sysreg,
	.nr_sysreg_clk_regs	= ARRAY_SIZE(drcg_alt_memclk_sysreg),
	.auto_clock_gate	= true,
	.gate_dbg_offset	= EXYNOS9610_GATE_DBG_OFFSET,
	.drcg_offset		= EXYNOS9610_ALT_DRCG_EN_OFFSET,
...
static const struct samsung_gate_clock cmgp_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_CMGP_I2C_CMGP00_PCLK, "gout_clk_cmgp_i2c_cmgp00_pclk",
	     "gout_cmu_cmgp_bus", CLK_CON_GAT_GOUT_CMGP_I2C_CMGP00_PCLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_CMGP_I2C_CMGP01_PCLK, "gout_clk_cmgp_i2c_cmgp01_pclk",
	     "gout_cmu_cmgp_bus", CLK_CON_GAT_GOUT_CMGP_I2C_CMGP01_PCLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_CMGP_I2C_CMGP02_PCLK, "gout_clk_cmgp_i2c_cmgp02_pclk",
	     "gout_cmu_cmgp_bus", CLK_CON_GAT_GOUT_CMGP_I2C_CMGP02_PCLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_CMGP_I2C_CMGP03_PCLK, "gout_clk_cmgp_i2c_cmgp03_pclk",
	     "gout_cmu_cmgp_bus", CLK_CON_GAT_GOUT_CMGP_I2C_CMGP03_PCLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_CMGP_I2C_CMGP04_PCLK, "gout_clk_cmgp_i2c_cmgp04_pclk",
	     "gout_cmu_cmgp_bus", CLK_CON_GAT_GOUT_CMGP_I2C_CMGP04_PCLK,
	     21, 0, 0),
...
static const struct samsung_gate_clock core_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_CORE_G3D_OCC_CLK, "gout_core_g3d_occ_clk",
	     "mout_pll_core_g3d_user", CLK_CON_GAT_GOUT_CORE_G3D_OCC_CLK,
	     21, 0, 0),
...
static const struct samsung_gate_clock dispaud_gate_clks[] __initconst = {
	...
	GATE(CLK_GOUT_DISPAUD_BTM_DPU_ACLK, "gout_dispaud_btm_dpu_aclk",
	     "mout_pll_dispaud_disp_user", CLK_CON_GAT_GOUT_DISPAUD_BTM_DPU_ACLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_DISPAUD_LHS_ACEL_D_DPU_CLK, "gout_dispaud_lhs_acel_d_dpu_clk",
	     "mout_pll_dispaud_disp_user", CLK_CON_GAT_GOUT_DISPAUD_LHS_ACEL_D_DPU_CLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_DISPAUD_PPMU_DPU_ACLK, "gout_dispaud_ppmu_dpu_aclk",
	     "mout_pll_dispaud_disp_user", CLK_CON_GAT_GOUT_DISPAUD_PPMU_DPU_ACLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_DISPAUD_CLK_DISP_CLK, "gout_dispaud_clk_disp_clk",
	     "mout_pll_dispaud_disp_user", CLK_CON_GAT_GOUT_DISPAUD_CLK_DISP_CLK,
	     21, 0, 0),
	...
	GATE(CLK_GOUT_DISPAUD_SMMU_DPU_CLK, "gout_dispaud_smmu_dpu_clk",
	     "mout_pll_dispaud_disp_user", CLK_CON_GAT_GOUT_DISPAUD_SMMU_DPU_CLK,
	     21, 0, 0),
...
static const unsigned long fsys_clk_regs[] __initconst = {
	...
	CLK_CON_GAT_GOUT_FSYS_UFS_EMBD_CLK_UNIPRO,
