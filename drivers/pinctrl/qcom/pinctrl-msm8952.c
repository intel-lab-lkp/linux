...
static const char *const codec_mad_groups[] = { "gpio13" };
static const char *const pwr_crypto_enabled_b_groups[] = { "gpio13" };
static const char *const blsp_i2c4_groups[] = {
	"gpio14",
	"gpio15",
};
static const char *const nfc_disable_groups[] = { "gpio16" };
...
static const char *const nfc_irq_groups[] = { "gpio17" };
...
static const char *const cam1_standby_groups[] = { "gpio35" };
static const char *const pwr_nav_enabled_a_groups[] = { "gpio35" };
static const char *const cam1_rst_groups[] = { "gpio36" };
static const char *const pwr_crypto_enabled_a_groups[] = { "gpio36" };
static const char *const cam2_standby_groups[] = { "gpio37" };
static const char *const cam2_rst_groups[] = { "gpio38" };
static const char *const webcam_standby_groups[] = { "gpio39" };
static const char *const cci_async_groups[] = { "gpio39" };
static const char *const webcam_rst_groups[] = { "gpio40" };
static const char *const rcm_marker1_groups[] = { "gpio41" };
static const char *const sd_write_groups[] = { "gpio41" };
static const char *const qdss_cti_trig_out_a0_groups[] = { "gpio41" };
static const char *const accel_int_groups[] = { "gpio42" };
static const char *const gcc_gp1_clk_a_groups[] = { "gpio42" };
static const char *const alsp_int_groups[] = { "gpio43" };
static const char *const gcc_gp2_clk_a_groups[] = { "gpio43" };
static const char *const mag_int_groups[] = { "gpio44" };
static const char *const gcc_gp3_clk_a_groups[] = { "gpio44" };
static const char *const gyro_int_groups[] = { "gpio45" };
static const char *const pressure_int_groups[] = { "gpio46" };
static const char *const fp_gpio_groups[] = { "gpio47" };
static const char *const blsp6_spi_groups[] = {
	"gpio47",
	"gpio48",
};
static const char *const fp_int_groups[] = { "gpio48" };
...
static const char *const us_euro_groups[] = { "gpio63" };
...
static const char *const ts_resout_groups[] = { "gpio64" };
static const char *const ts_sample_groups[] = { "gpio65" };
...
static const char *const sdcard_det_groups[] = { "gpio67" };
...
static const char *const audio_reset_groups[] = { "gpio68" };
...
static const char *const codec_int1_groups[] = { "gpio73" };
static const char *const codec_int2_groups[] = { "gpio74" };
...
static const char *const key_volp_groups[] = { "gpio85" };
static const char *const key_snapshot_groups[] = { "gpio86" };
static const char *const key_focus_groups[] = { "gpio87" };
static const char *const gcc_tlmm_groups[] = { "gpio87" };
static const char *const key_home_groups[] = { "gpio88" };
static const char *const dmic0_clk_groups[] = { "gpio89" };
static const char *const dmic0_data_groups[] = { "gpio90" };
static const char *const backlight_en_groups[] = { "gpio91" };
static const char *const qdss_cti_trig_in_a1_groups[] = { "gpio91" };
static const char *const lcd_en_groups[] = { "gpio92" };
...
static const char *const usbc_irq_groups[] = { "gpio93" };
...
static const char *const uim3_ldo_groups[] = { "gpio96" };
...
static const char *const wsa_irq_groups[] = { "gpio97" };
...
static const struct msm_pingroup msm8952_groups[] = {
	...
	PINGROUP(6, blsp_spi2, blsp_uart2, blsp_i2c2, gcc_gp1_clk_b, NA, NA, NA,
		 NA, NA),
	PINGROUP(7, blsp_spi2, blsp_uart2, blsp_i2c2, NA, NA,
		 atest_gpsadc_dtest0_native, NA, NA, NA),
	...
	PINGROUP(36, pwr_crypto_enabled_a, NA, NA, NA, NA, NA, NA, NA,
		 qdss_tracedata_a),
	PINGROUP(37, NA, NA, NA, NA, NA, qdss_tracedata_a, NA, NA, NA),
	...
	PINGROUP(41, sd_write, NA, NA, NA, NA, NA, NA, qdss_cti_trig_out_a0,
		 NA),
	...
	PINGROUP(44, gcc_gp3_clk_a, qdss_tracedata_b, NA,
		 atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(45, NA, qdss_tracedata_b, NA, atest_combodac_to_gpio_native,
		 NA, NA, NA, NA, NA),
	PINGROUP(46, NA, qdss_tracedata_b, NA, atest_combodac_to_gpio_native,
		 NA, NA, NA, NA, NA),
	PINGROUP(47, blsp6_spi, NA, qdss_tracedata_b, NA,
		 atest_combodac_to_gpio_native, NA, NA, NA, NA),
	PINGROUP(48, blsp6_spi, NA, qdss_cti_trig_in_b1, NA,
		 atest_combodac_to_gpio_native, NA, NA, NA, NA),
	PINGROUP(49, uim_batt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(50, qdss_cti_trig_out_b1, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(59, uim3_data, usb_fs, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(60, uim3_clk, usb_fs, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(61, uim3_reset, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(62, uim3_present, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(82, wcss_fm, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(83, wcss_bt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(84, wcss_bt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(85, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(86, qdss_tracedata_b, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(87, qdss_tracedata_b, gcc_tlmm, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(88, pri_mi2s, NA, NA, NA, NA, NA, NA, NA, qdss_tracedata_b),
