...
static const struct pinctrl_pin_desc sm8475_pins[] = {
 ...
 */
static const struct msm_pingroup sm8475_groups[] = {
...
static const struct msm_gpio_wakeirq_map sm8475_pdc_map[] = {
...
static const struct msm_pinctrl_soc_data sm8475_tlmm = {
	.pins = sm8475_pins,
	.npins = ARRAY_SIZE(sm8475_pins),
	.functions = sm8475_functions,
	.nfunctions = ARRAY_SIZE(sm8475_functions),
	.groups = sm8475_groups,
	.ngroups = ARRAY_SIZE(sm8475_groups),
	.ngpios = 211,
	.wakeirq_map = sm8475_pdc_map,
	.nwakeirq_map = ARRAY_SIZE(sm8475_pdc_map),
	.egpio_func = 9,
};

static int sm8475_tlmm_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &sm8475_tlmm);
}

static const struct of_device_id sm8475_tlmm_of_match[] = {
...
{
	return platform_driver_register(&sm8475_tlmm_driver);
}
arch_initcall(sm8475_tlmm_init);

static void __exit sm8475_tlmm_exit(void)
{
	platform_driver_unregister(&sm8475_tlmm_driver);
}
module_exit(sm8475_tlmm_exit);

MODULE_DESCRIPTION("QTI SM8475 TLMM driver");
