...
struct perf_sample {
	 ...
	 *                      user callchain marker was encountered. When set
	 *                      the callchain entry is allocated.
	 */
	 ...
	 *             data. If deferred_callchain is not set, it just points to
	 *             data in the mmap buffer and it should not be freed.
	 */
