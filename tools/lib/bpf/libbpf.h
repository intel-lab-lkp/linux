 ...
 * opts->offset is treated as a raw kernel address. This form is
 * supported with PROBE_ATTACH_MODE_PERF and PROBE_ATTACH_MODE_LINK,
 * and can fail with PROBE_ATTACH_MODE_DEFAULT if libbpf falls back to
 * legacy attach.
