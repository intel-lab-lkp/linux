...
/*
 * A request that does not fit the server's buffer is rejected with -EIO.
 * SETXATTR is special, since it may contain too large data, and is
 * rejected with -E2BIG like the VFS setxattr path.
 */
