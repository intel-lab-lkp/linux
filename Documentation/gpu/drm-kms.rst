...
.. kernel-render:: DOT
   ...
   digraph {
      ...
      subgraph cluster_state {
          ...
          "drm_atomic_update" -> "duplicated drm_plane_state A"
          "drm_atomic_update" -> "duplicated drm_plane_state B"
          "drm_atomic_update" -> "duplicated drm_crtc_state"
          "drm_atomic_update" -> "duplicated drm_connector_state"
          "drm_atomic_update" -> "duplicated driver private state"
      }
      ...
      "drm_atomic_update" -> "drm_device" [label="atomic_commit"]
...
- An atomic update is assembled and validated as an entirely free-standing pile
  of structures within the :c:type:`drm_atomic_update <drm_atomic_update>`
