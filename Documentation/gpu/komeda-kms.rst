...
state will be managed by drm_atomic_update as well.
...
Tracking component_state/pipeline_state by drm_atomic_update
------------------------------------------------------------
...
.. code-block:: c
                ...
                struct drm_plane/crtc/connector_state, *user_state)
    {
         ...
         Setup 3: get component_state from drm_atomic_update, and try set to set
