...
`debugging script <https://git.kernel.org/pub/scm/linux/kernel/git/superm1/amd-debug-tools.git/tree/amd_s2idle.py>`_
has been created that can help test for common problems and offer suggestions::

  # git clone git://git.kernel.org/pub/scm/linux/kernel/git/superm1/amd-debug-tools.git
  # cd amd-debug-tools
  # sudo ./amd_s2idle.py
