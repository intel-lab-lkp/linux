...
enum scx_ops_flags {
	 ...
	 * next tick, which promotes the request. When lazy preemption is disabled
	 * at runtime, the request behaves like an immediate reschedule.
	 * Rescheduling while bypassing stays immediate.
	 */
